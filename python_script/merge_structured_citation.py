...
from uparxive.reference_reterive.merge_anystyle_and_grobid_result import process_one_path, MergeStructureConfig
...
if __name__ == '__main__':
    ...
    parser.add_arguments(MergeStructureConfig, dest="config")
    args = parser.parse_args()
    args = args.config

    alread_processing_file_list = obtain_processed_filelist(args)
    results = process_files(process_one_path_wrapper, alread_processing_file_list, args)
