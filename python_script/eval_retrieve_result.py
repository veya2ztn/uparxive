...
from uparxive.reference_reterive.evaluate_reterive_quality import process_one_path_wrapper, QualityESConfig
...
if __name__ == '__main__':
    ...
    parser.add_arguments(QualityESConfig, dest="config")
