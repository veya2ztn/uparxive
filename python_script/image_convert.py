...
from uparxive.lougat.convert_image_from_other_format_into_png import process_one_file_wrapper, ImgaeConverterConfig
from simple_parsing import ArgumentParser

import os
if __name__ == '__main__':
    parser = ArgumentParser()
    parser.add_arguments(ImgaeConverterConfig, dest="config")
