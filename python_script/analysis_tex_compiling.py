...
from uparxive.tex_to_xml.analysis_tex_to_xml import TexCompilingConfig,analysis_tex_to_xml_wrapper
from simple_parsing import ArgumentParser
import os

if __name__ == '__main__':
    parser = ArgumentParser()
    parser.add_arguments(TexCompilingConfig, dest="config")
    args = parser.parse_args()
    args = args.config

    alread_processing_file_list = obtain_processed_filelist(args)
    results = process_files(analysis_tex_to_xml_wrapper, alread_processing_file_list, args)
