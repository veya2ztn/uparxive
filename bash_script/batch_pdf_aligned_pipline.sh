...
START=$2
CPU_NUM=2400 # Automatically get the number of CPUs
CHUNKSIZE=200
...
do
    nohup bash ~/projects/unarXive/src/bash_script/pdf_alignment_pipline.sh $FILEPATH $(($CPU+$START)) $CHUNKSIZE > log/convert/thread.$CPU.log&
done 