        ...
        if  isinstance(element, Token):
            ...
            if commend in default_use_adjoint_char_math_func:
                ...
                while len(element.args)>0:
                    ...
                    elements.insert(i+1, element.args.pop(-1))
